...
const About = () => {
  return (
    <>
      <main>
        <article>
          <header className="mx-auto mt-20 max-w-screen-lg rounded-t-lg bg-white pt-16 text-center shadow-lg">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-2 uppercase">
              <a className="rounded-lg bg-gray-100 px-2 py-1 font-medium text-gray-600 hover:bg-gray-200">
                Hospital
              </a>
              <a className="rounded-lg bg-gray-100 px-2 py-1 font-medium text-gray-600 hover:bg-gray-200">
                Doctor
            ...
            <img
              className="-z-10 absolute top-0 left-0 mt-12 h-96 w-full object-fit"
              src="https://i.pinimg.com/originals/0c/1a/12/0c1a129ce95bb1e5716254e03f277600.gif"
              alt=""
            />
          </header>
      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12 px-28">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">
            Using Stack
          </h2>
          <div className="grid grid-cols-2 gap-6 rounded-lg bg-indigo-100 p-6 sm:h-40 sm:content-evenly md:grid-cols-4">
            {/* logo - start */}
