...
const DoctorChangePassword = (state) => {
  ...
  const handleUpdatePassword = async (e) => {
    ...
    const filter = {
      doctorLicenseId: state.doctorId,
    ...
    try {
      ...
      if (data.status === 200) {
        await contract.methods
          .updateDoctorPassword(doctorId, oldpassword, newPassword)
          .send({ from: account });
      ...
      <div className="pt-24">
        <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl border border-gray-300">
          <div
            ...
            style={{
              backgroundImage:
                'url("https://images.unsplash.com/photo-1666886572860-64254ee2ce77?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
            }}
          />
